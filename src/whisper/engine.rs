...
impl WhisperConfig<'_> {
    pub fn fast() -> Self {
        Self { n_threads: 2, no_speech_thold: 0.5, temperature: 0.0, context_prompt: "", pass: 1 }
    }
 
    pub fn accurate(context_prompt: &str) -> WhisperConfig<'_> {
        WhisperConfig { n_threads: 1, no_speech_thold: 0.4, temperature: -1.0, context_prompt, pass: 2 }
    }
}
...
pub fn run_whisper(
    ...
    tracing::info!("EXIT full pass={} ms={}", cfg.pass, t0.elapsed().as_millis());
