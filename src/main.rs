...
use translator::{
    ...
    utility::{
        stats,
        utils::{ModelInfo, ModelType, init_audio_dumper, merge_strings, start_test},
    },
    vad, whisper,
};
...
impl App {
    pub fn new(
        ...
        Self {
            ...
            downloading_models: std::sync::Arc::new(std::sync::Mutex::new(
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            egui::ScrollArea::both()
                ...
                .show(ui, |ui| {
                    ...
                    if ui
                        .add(
                            egui::Button::new(egui::RichText::new("START").heading())
                        ...
                        .clicked()
                    {
                        ...
                        self.handle
                            .spawn(translator::utility::utils::recording_task(
                                rx,
                                path,
                                should_save,
                            ));
                    ...
                    egui::ScrollArea::both()
                        ...
                        .show(ui, |ui| {
                            ...
                            ui.group(|ui| {
                                ...
                                if ui
                                    .add(egui::Slider::new(&mut gain, 1.0..=10.0).text("Mic Boost"))
                                    .changed()
                                {
                                ...
                                if ui
                                    .add(egui::Button::new(
                                        egui::RichText::new(btn_label).color(btn_color),
                                    ))
                                    .clicked()
                                {
                            ...
                            ui.group(|ui| {
                                ui.label(
                                    egui::RichText::new("VAD (Voice Activation Detection)")
                                        .strong(),
                                );
                                ...
                                if ui
                                    .add(
                                        egui::Slider::new(&mut prob, 0.1..=0.9).text("Sensitivity"),
                                    )
                                    .changed()
                                {
                                ...
                                if ui
                                    .add(
                                        egui::Slider::new(&mut max_silence, 1..=50)
                                            .text("Max Silence Chunks"),
                                    )
                                    .changed()
                                {
                                ...
                                if ui
                                    .add(
                                        egui::Slider::new(&mut preroll, 0..=20)
                                            .text("Preroll Chunks"),
                                    )
                                    .changed()
                                {
                            ...
                            ui.group(|ui| {
                                ...
                                if ui
                                    .add(
                                        egui::Slider::new(&mut stitch_sil, 0.1..=5.0)
                                            .step_by(0.1)
                                            .suffix("s")
                                            .text("Stitch Max Silence"),
                                    )
                                    .changed()
                                {
                                ...
                                if ui
                                    .add(
                                        egui::Slider::new(&mut fast_track, 0.5..=10.0)
                                            .step_by(0.1)
                                            .suffix("s")
                                            .text("Fast Track Threshold"),
                                    )
                                    .changed()
                                {
                                ...
                                if ui
                                    .add(
                                        egui::Slider::new(&mut min_w, 1.0..=8.0)
                                            .step_by(0.5)
                                            .suffix("s")
                                            .text("Min Context Window"),
                                    )
                                    .changed()
                                {
                                ...
                                if ui
                                    .add(
                                        egui::Slider::new(&mut max_w, 4.0..=30.0)
                                            .step_by(0.5)
                                            .suffix("s")
                            ...
                            ui.group(|ui| {
                                ...
                                let mut min_phrase =
                                    config::min_phrase_samples() as f32 / TARGET_SAMPLE_RATE as f32;
                                if ui
                                    .add(
                                        egui::Slider::new(&mut min_phrase, 0.1..=5.0)
                                            .step_by(0.1)
                                            .suffix("s")
                                            .text("Min Phrase Length"),
                                    )
                                    .changed()
                                {
                                ...
                                let mut max_phrase =
                                    config::max_phrase_samples() as f32 / TARGET_SAMPLE_RATE as f32;
                                if ui
                                    .add(
                                        egui::Slider::new(&mut max_phrase, 5.0..=60.0)
                                            .step_by(1.0)
                                            .suffix("s")
                            ...
                            if ui
                                .checkbox(&mut check_val, "Save transcription to disk")
                                .changed()
                            {
                            ...
                            if ui
                                .add(egui::Button::new(
                                    egui::RichText::new(tr_label).color(tr_color),
                                ))
                                .clicked()
                            {
                            ...
                            ui.group(|ui| {
                                ...
                                ui.horizontal(|ui| {
                                    ui.add(
                                        egui::TextEdit::singleline(&mut self.dict_new_word)
                                            .desired_width(120.0)
                                            .hint_text("Word"),
                                    );
                                    ui.label("->");
                                    ui.add(
                                        egui::TextEdit::singleline(&mut self.dict_new_trans)
                                            .desired_width(120.0)
                                ...
                                if ui.button("Add to custom.toml").clicked()
                                    && !self.dict_new_word.is_empty()
                                        && !self.dict_new_trans.is_empty()
                                    {
                                        translator::utility::utils::add_to_custom_dict(
                                            &self.dict_new_word,
                                            &self.dict_new_trans,
                                        );
